...
class TeacherTimetableExportTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_teacher_timetable_export_endpoint_returns_excel_download(): void
    {
    ...
    private function createTimetableData(): array
    {
        ...
        $subscriptionId = DB::table('subscriptions')->insertGetId([
            'school_name' => 'YouTutor Export Test School',
            'status' => 'active',
            'amount' => 0,
        ...
        $userId = $this->insertUser($subscriptionId, 'Administrator', 'export-admin@example.test', 'admin');
        $teacherId = $this->insertUser($subscriptionId, 'Export Teacher', 'export-teacher@example.test', 'teacher');
